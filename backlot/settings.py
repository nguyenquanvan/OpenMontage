...
LOCAL_FIELDS: tuple[dict[str, Any], ...] = (
    ...
    {"key": "VIENEU_MODEL_DIR", "label": "VieNeu-TTS tiếng Việt", "type": "text", "hint": "Thư mục model VieNeu v3 Turbo do Model Center quản lý."},
    {"key": "KOKORO_MODEL_DIR", "label": "Kokoro TTS tiếng Anh", "type": "text", "hint": "Thư mục Kokoro 82M và voice packs."},
    {"key": "REALESRGAN_MODEL_DIR", "label": "Real-ESRGAN", "type": "text", "hint": "Checkpoint nâng độ phân giải ảnh/video."},
    {"key": "U2NET_HOME", "label": "rembg / U2Net", "type": "text", "hint": "Thư mục model xóa nền U2Net và Silueta."},
    {"key": "FACE_RESTORE_MODEL_DIR", "label": "GFPGAN / CodeFormer", "type": "text", "hint": "Checkpoint phục hồi khuôn mặt; CodeFormer chỉ dùng phi thương mại."},
    {"key": "RIFE_MODEL_DIR", "label": "RIFE interpolation", "type": "text", "hint": "Runtime nội suy khung hình RIFE NCNN."},
    {"key": "FLORENCE_MODEL_DIR", "label": "Florence-2", "type": "text", "hint": "Model mô tả cảnh, object detection và visual analysis."},
    {"key": "PADDLEOCR_MODEL_DIR", "label": "PaddleOCR", "type": "text", "hint": "Model OCR mobile cho chữ Latin và tiếng Việt."},
    {"key": "DEPTH_ANYTHING_MODEL_DIR", "label": "Depth Anything", "type": "text", "hint": "Model depth map phục vụ parallax và 2.5D."},
    {"key": "SAM2_MODEL_DIR", "label": "SAM 2", "type": "text", "hint": "Model phân đoạn và theo dõi vật thể."},
    {"key": "MUSETALK_MODEL_DIR", "label": "MuseTalk", "type": "text", "hint": "Model lip-sync thương mại chạy local."},
    {"key": "WAV2LIP_PATH", "label": "Wav2Lip research", "type": "text", "hint": "Chỉ dùng cá nhân/nghiên cứu, nghiêm cấm dùng thương mại."},
    {"key": "MLX_WHISPER_MODEL_DIR", "label": "MLX Whisper", "type": "text", "hint": "Whisper tối ưu cho Apple Silicon."},
    {"key": "MUSICGEN_MODEL_DIR", "label": "MusicGen research", "type": "text", "hint": "Chỉ dùng nghiên cứu do license CC-BY-NC."},
    {"key": "QWEN_VL_MODEL_DIR", "label": "Qwen VL research", "type": "text", "hint": "Chỉ dùng nghiên cứu theo Qwen Research License."},
